/* PrismJS 1.27.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+python&plugins=highlight-keywords+autoloader+toolbar+copy-to-clipboard+download-button+match-braces */
var _self =
...
!(function () {
  if ("undefined" != typeof Prism && "undefined" != typeof document) {
    var e = {
      ...
      r = {},
      t = "components/",
      s = Prism.util.currentScript();
    if (s) {
      var i =
          /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
        l = /(^|\/)[\w-]+\.(?:min\.)?js(?:\?[^\r\n/]*)?$/i,
        c = s.getAttribute("data-autoloader-path");
      if (null != c) t = c.trim().replace(/\/?$/, "/");
      else {
        var n = s.src;
        i.test(n)
          ? (t = n.replace(i, "components/"))
          : l.test(n) && (t = n.replace(l, "$1components/"));
      }
    }
    ...
    Prism.hooks.add("complete", function (e) {
      ...
      if (a && r && "none" !== r) {
        ...
        /^diff-./i.test(r)
          ? (t.push("diff"), t.push(r.substr("diff-".length)))
          : t.push(r),
          t.every(o) ||
            m(t, function () {
      ...
      ? t.forEach(function (t) {
          !(function (t, s, i) {
            ...
            function c() {
              var e = r[t];
              e || (e = r[t] = { callbacks: [] }),
                e.callbacks.push({ success: s, error: i }),
                !l && o(t)
                  ? u(t, "success")
                  : !l && e.error
                  ? u(t, "error")
                  : (!l && e.loading) ||
                    ...
                    (function (e, a, r) {
                      ...
                      function () {
                        (e.loading = !1), u(t, "success");
                      },
                      function () {
                        (e.loading = !1), (e.error = !0), u(t, "error");
                      }
                    ));
            }
            t = t.replace("!", "");
  ...
  function u(e, a) {
    if (r[e]) {
      for (var t = r[e].callbacks, s = 0, i = t.length; s < i; s++) {
        var l = t[s][a];
        l && setTimeout(l, 0);
      }
      t.length = 0;
